...
export default function StyleSheetsMixin<ClassType extends Constructor<LitElement>>(
  superClass: ClassType
): Constructor<LitElement> & ClassType {
  class StyleSheetsMixinClass extends superClass {
    static styles: CSSResult[] = [
      ...
      `,
      ...(((superClass as unknown as typeof LitElement).styles as CSSResult[] | undefined) ?? []),
    ];
  }
  return StyleSheetsMixinClass as unknown as Constructor<LitElement> & ClassType;
}

export const AppElement = StyleSheetsMixin(LitElement);
